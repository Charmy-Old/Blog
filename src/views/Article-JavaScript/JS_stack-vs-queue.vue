        ...
        <main>
            ...
            <section>
                <div class="article-detail">
                    ...
                    <div class="article-detailLine"></div>
                    <div class="article-txt">
                        <p>堆疊是一種後進先出(Last-In-First-Out，LIFO)的資料結構，也就是說最後一個加入堆疊的元素將是第一個被移除的，就像堆疊盤子一樣，只能從最上面放入和移除。在 JavaScript 中，堆疊通常用於追蹤函數的呼叫和返回，或是處理遞迴等情況。</p>
                        <p>在堆疊中，兩個主要操作是「壓入」(push)和「彈出」(pop)：</p>
                    </div>
                    <div class="article-list">
                        <ul>
                            <li><i class="fa-solid fa-check"></i>壓入：將元素添加到堆疊的頂部</li>
                            <li><i class="fa-solid fa-check"></i>彈出：從堆疊的頂部移除元素</li>
                        </ul>
                    </div>
                    <div class="article-txt">
...
console.log(history.getCurrentPage());   // Output: https://www.example.com/page1
            ...
            <section>
                <div class="article-detail">
                    ...
                    <div class="article-list">
                        <ul>
                            <li><i class="fa-solid fa-check"></i>入隊：將元素添加到佇列的尾部</li>
                            <li><i class="fa-solid fa-check"></i>出隊：從佇列的前端移除元素</li>
                        </ul>
                    </div>
                    <div class="article-txt">
...
// Task 3 executed
            ...
            <section>
                <div class="article-detail">
                    ...
                    <div class="article-detailLine"></div>
                    <div class="article-txt">
                        <p>堆疊和佇列都是資料結構，用於管理和操作資料的方式。堆疊使用後進先出的原則，最後進入的元素最先被處理，而佇列使用先進先出的原則，最早進入的元素最先被處理。在不同的程式設計場景中，可以選擇使用堆疊或佇列來更有效地處理資料。</p>
                    </div>
                </div>
            </section>
