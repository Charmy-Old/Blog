            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <h4>定義</h4>
                        <p>創建一個新的數組，其中每一個元素由調用數組中的每一個元素執行提供的函數得來(creates a new array with the results of calling a provided
                            function on every element in the calling array)。map 方法會給原數組中的每個元素都按順序調用一次 callback 函數。callback
                            每次執行後的返回值（包括 undefined）組合起來形成一個新數組。 callback 函數只會在有值的索引上被調用；那些從來沒被賦過值或者使用 delete 刪除的索引則不會被調用。
                        </p>
                    </div>
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <h4>定義</h4>
                        <p>針對每一個元素執行提供的函數(executes a provided function once for each array element)。除了拋出異常以外，沒有辦法中止或跳出
                            forEach() 迴圈。如果你需要中止或跳出迴圈，forEach() 方法不是應當使用的工具。</p>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                        data-aos-delay="150" data-aos-duration="1000">
                        <pre>
                ...
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>每一次執行匿名函數都支持三個參數，數組中的當前項item，當前項的索引index，原始數組input
                            </li>
...
expected output：undefined
            ...
            <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                ...
                <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    data-aos-duration="1000">
                    <a class="article-reference" href="https://blog.csdn.net/suwu150/article/details/111590409"
                        target="_blank"><i class="fa-solid fa-pen-to-square"></i>suwu150 - map()和forEach()的區別和理解</a>
                </div>
            </div>
        </section>
    </main>
