...
操作結果: 操作完成   // 2秒後才顯示
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>範例中，asyncOperation 函數模擬了一個耗時的操作，使用 setTimeout 函數模擬了2秒的延遲。該函數接受一個 CallBack Function作為參數，並在操作完成後呼叫該
                            CallBack Function。</p>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                        data-aos-delay="150" data-aos-duration="1000">
...
console.log("結束");
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>Callback Hell 是一個在 JavaScript 中常見的問題，特別是在處理非同步操作時。它描述了一個由於多個嵌套的 Callback Functions
                            而變得混亂和難以管理的程式碼結構。</p>
                        <p>在JavaScript中，非同步操作是非常常見的，例如從服務器獲取數據、執行文件讀寫操作或處理用戶界面事件等。為了處理這些非同步操作，通常會使用 Callback Functions
                            來指定非同步操作完成後應該執行的程式碼。</p>
    ...
    doSomethingElse(result1, function(result2) {
        doAnotherThing(result2, function(result3) {
            // 在這裡執行更多的操作...
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>上述範例中，每個非同步操作的完成都需要等待前一個非同步操作的結果，並且為每個操作定義了一個 Callback Functions 。由於這些 Callback Functions
                            被嵌套在彼此之中，程式碼變得非常難以閱讀和維護。</p>>
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <h5>結構</h5>
                        <p>Promise 本身是一個建構函式，函式也是屬於物件的一種，因此可以附加其它屬性方法在上，透過 console 的結果可以看到 Promise 可以直接使用
                            all、race、resolve、reject 的方法，寫法如下：</p>
                    </div>
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <ul>
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>Promise 建構函式 new 出的物件，則可以使用其中的原型方法 (在 prototype 內)，其中就包含 then、catch、finally，這些方法則必須在新產生的物件下才能呼叫。
                        </p>
...
p.finally();   // 非同步執行完畢(無論是否正確完成)
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>除此之外，Promise 建構函式建立同時，必須傳入一個函式作為參數（executor function），此函式的參數包含 resolve,
                            reject，這兩個方法分別代表成功與失敗的回傳結果，特別注意這兩個僅能回傳其中之一，回傳後表示此 Promise 事件結束。</p>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                        data-aos-delay="150" data-aos-duration="1000">
                        <pre>
    ...
    reject();   // 失敗的回傳方法
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>resolved：事件已經執行完畢且成功操作，回傳 resolve 的結果（該承諾已經被實現
                                fulfilled）</li>
...
.catch(function(error) {
    console.log(error);   // 異常處理，數據獲取失敗時執行
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <p>使用 .then 方法可以註冊 Promise 完成時的 Callback Function，並將獲取的數據作為參數傳遞給該 Callback Function。如果 Promise
                            狀態變為拒絕，則可以使用 .catch 方法註冊錯誤處理的 Callback Function，並將錯誤信息作為參數傳遞給該 Callback Function。</p>
...
getData();
                ...
                <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    data-aos-duration="1000">
                    <h4>在上面的範例中，getData函數是一個非同步函數。在函數體內，使用 await 關鍵字等待fetch函數返回的 Promise 對象。一旦 Promise 對象解決，它會將響應轉換為
                        JSON 數據並存儲在 data 變數中</h4>
        ...
        <section>
            <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                ...
                <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    data-aos-duration="1000">
                    <a class="article-reference" href="https://www.casper.tw/development/2020/02/16/all-new-promise/"
                        target="_blank"><i class="fa-solid fa-pen-to-square"></i>卡斯伯的 Blog - JavaScript Promise 全介紹</a>
                    <a class="article-reference" href="https://www.casper.tw/development/2020/10/16/async-await/"
                        target="_blank"><i class="fa-solid fa-pen-to-square"></i>卡斯伯的 Blog - Async function / Await
                        深度介紹</a>
                </div>
            </div>
        </section>
