            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-solid fa-check"></i>淺拷貝：共用同一個記憶體空間</li>
                            <li><i class="fa-solid fa-check"></i>深拷貝：兩個不同的記憶體空間</li>
                        </ul>
                    </div>
                </div>
            </section>
...
console.log(object2.a)   // 2
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <p>不以JS的邏輯看，依正常程式運作原理應該會輸出 1 才對，因為運作的原理是 call by value，但 JS 對於物件的操作是 call by reference，所以上面程式碼中的 object1 以及 object2 其實是共用同一個記憶體，所以只要有一方的值改變了另一方也會跟著改變，這就叫淺拷貝。</p>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
<pre>
let object1 = {a: 1}
...
console.log(object2.a)   // 輸出{a: 2}而不是{a: 1}
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <h4>常見陷阱</h4>
                        <h5><i class="fa-solid fa-pencil"></i>... operator</h5>
...
console.log(obj2.a)  // {a: 2}
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <h5><i class="fa-solid fa-pencil"></i>Object.assign(target, source)</h5>
...
console.log(object2.a)   // {a: 2}
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <h4>以下幾個深拷貝的操作。</h4>
                        <h5><i class="fa-solid fa-pencil"></i>JSON.stringify(object) 以及 JSON.parse(JSONString)</h5>
...
console.log(object2.a)   // {a: 1}
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <h5><i class="fa-solid fa-pencil"></i>lodash 內的 cloneDeep</h5>
                        <p>lodash 是 JS 中一套非常強大的 utility library，裡面有一個 API 叫 _.cloneDeep(object) ，這個就會回傳一個利用深拷貝而得到的新物件，這個方法也是比較簡單而且看起來也比較乾淨的作法。</p>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
<pre>
let object1 = &#123;a: &#123;a: 1&#125;&#125;
...
console.log(object2.a)   // {a: 1}
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-detailLine"></div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <a class="article-reference" href="https://medium.com/andy-blog/%E9%97%9C%E6%96%BCjs%E4%B8%AD%E7%9A%84%E6%B7%BA%E6%8B%B7%E8%B2%9D-shallow-copy-%E4%BB%A5%E5%8F%8A%E6%B7%B1%E6%8B%B7%E8%B2%9D-deep-copy-5f5bbe96c122" target="_blank"><i class="fa-solid fa-pen-to-square"></i>Medium(Written by Andy Chen) - 關於JS中的淺拷貝(shallow copy)以及深拷貝(deep copy)</a>
                    </div>
                </div>
            </section>
        </main>
