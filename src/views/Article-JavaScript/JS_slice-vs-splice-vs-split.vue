        ...
        <main>
            <section>
                <div class="article-heading">
                    <h2 class="article-heading">slice() V.S. splice() V.S. split()</h2>
...
console.log(arr)   // [1, 2, 3, 4, 5]
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>arr.slice(-1) 開始位子為負數的話，會從陣列的最後一個索引位子開始往前推</li>
                            <li><i class="fa-regular fa-note-sticky"></i>arr 最後我們可以發現原陣列 arr 並未改變</li>
                        </ul>
                    </div>
                </div>
            </section>
...
console.log(NewArray3)   // [ "Hello", " Charmy" ]
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>str.split(",", 2) 以","做為分隔前後的字符，但只取前兩個</li>
                        </ul>
                    </div>
                </div>
            </section>
                    ...
                    <div class="article-table" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>用法</td>
                                    <td>arr.slice(begin, end)<br>str.slice(begin, end)</td>
                                    <td>array.splice(start, deleteCount, item1, item2, ...)</td>
                                    <td>str.split(separator, limit)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
