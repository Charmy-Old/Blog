...
console.log(numbers);   // [1, 2, 4, 6, 8]
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>上述範例中 numbers 陣列中的數字會被轉換為字串，然後按照 Unicode
                            編碼順序進行排序。這樣在某些情況下會產生預期外的結果，因此如果想根據數字大小而不是字串順序進行排序，可以提供一個比較函式。</p>
                        <h4>自定義比較函式：</h4>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                        data-aos-delay="150" data-aos-duration="1000">
...
console.log(numbers);   // [1, 2, 4, 6, 8]
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>上述範例中比較函式 function(a, b) { return a - b; } 會將陣列元素按照數字的大小進行升序排序。如果比較函式返回負數，表示 a 應該在 b 之前；如果返回正數，表示
                            b 應該在 a 之前；如果返回零，表示它們相等，順序不變。</p>
                        <h4>降序排序：</h4>
                    </div>
                    <div class="article-coding" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                        data-aos-delay="150" data-aos-duration="1000">
...
array.toSorted([compareFn])
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>array 是需要排序的數組</li>
                            <li><i class="fa-regular fa-note-sticky"></i>compareFn
                                是可選的，指定排序順序的函數。如果省略，則將數組元素轉換為字符串，然後根據每個字符的 Unicode 碼位值進行排序</li>
                        </ul>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>JavaScript 中的 sort() 和 toSorted() 都是用來對陣列進行排序的函數
                            </li>
                            <li><i class="fa-regular fa-note-sticky"></i>sort() 方法會原地對陣列的所有元素進行排序，並返回此陣列。排序不一定是穩定的</li>
                            <li><i class="fa-regular fa-note-sticky"></i>toSorted() 方法會返回一個新陣列，其元素按升序排列。排序是穩定的</li>
                        </ul>
                    </div>
