        ...
        <main>
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>事件捕獲是事件傳播的第一個階段。當一個事件發生在巢狀的 DOM
                            元素中時，瀏覽器會從最外層的祖先元素開始，逐級向下到目標元素。在這個階段，事件會觸發祖先元素的事件處理程序，然後逐級傳遞到目標元素。</p>
...
element.addEventListener("click", myFunction, true);   // 第三個參數為 true，啟用事件捕獲階段
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <p>事件冒泡是事件傳播的第二個階段，也是默認階段。當目標元素上觸發了一個事件時會向上冒泡，從目標元素開始，逐級向上到最外層的祖先元素。意味著事件會在觸發元素的父元素、祖父元素等等上觸發相同類型的事件處理程序。
                        </p>
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>事件捕獲階段從祖先元素向目標元素傳播，很少使用</li>
                            <li><i class="fa-regular fa-note-sticky"></i>事件冒泡階段從目標元素向祖先元素傳播，是默認的傳播方式，也是最常用的</li>
                            <li><i class="fa-regular fa-note-sticky"></i>使用 addEventListener 添加事件處理時，通過設置 useCapture 參數為
                                true 可以啟用事件捕獲階段，為 false 或省略參數則使用事件冒泡階段</li>
                            <li><i class="fa-regular fa-note-sticky"></i>使用 event.stopPropagation() 方法可以阻止事件在捕獲或冒泡階段繼續傳播
                            </li>
                    </ul>
                </div>
            </div>
