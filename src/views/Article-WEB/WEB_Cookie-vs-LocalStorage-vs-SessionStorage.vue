            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <p>HTTP cookie（web cookie、browser cookie）為伺服器傳送給使用者瀏覽器的一個小片段資料。瀏覽器可能儲存並在下一次請求回傳 cookie
                            至相同的伺服器。Cookie 通常被用來保持使用者的登入狀態 — — 如果兩次請求都來自相同的瀏覽器。有個數限制（各瀏覽器不同），一般不能超過20個</p>
                    </div>
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>每次 request 時都會帶上</li>
                        </ul>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>Session 管理：帳號登入、購物車、遊戲分數，或任何其他伺服器應該記住的資訊</li>
                            <li><i class="fa-regular fa-note-sticky"></i>個人化：使用者設定、佈景主題，以及其他設定</li>
                            <li><i class="fa-regular fa-note-sticky"></i>追蹤：記錄並分析使用者行為</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <p>從字面上的意思就可以看出，sessionStorage將資料儲存在session中，瀏覽器關閉也就沒了；而localStorage則一直將資料儲存在客戶端本地；
                            不管是sessionStorage，還是localStorage，可使用的API都相同。</p>
                    </div>
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>都是使用 key / value pair 的方式 給值或取值</li>
                            <li><i class="fa-regular fa-note-sticky"></i>大小預設有 5mb</li>
                            <li><i class="fa-regular fa-note-sticky"></i>每次 request 不會帶上</li>
                        </ul>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        ...
                        <p>從字面上的意思就可以看出，sessionStorage將資料儲存在session中，瀏覽器關閉也就沒了；而localStorage則一直將資料儲存在客戶端本地；
                            不管是sessionStorage，還是localStorage，可使用的API都相同。</p>
                        <p>生命周期只存在瀏覽囂的 單一分頁 ，也就是 另開新分頁的話 ，又是一個 新的sessionStorage ，預設無逾期時間，除非關閉該分頁、關閉瀏覽器等，sessionStorage就會消失。
                        </p>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                        data-aos-duration="1000">
            ...
            <section>
                ...
                <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <a class="article-reference"
                        href="https://medium.com/@bebebobohaha/cookie-localstorage-sessionstorage-%E5%B7%AE%E7%95%B0-9e1d5df3dd7f"
                        target="_blank"><i class="fa-solid fa-pen-to-square"></i>Medium(Written by Peggy Chan) -
                        [JavaScript] Cookie、LocalStorage、SessionStorage 差異</a>
                </div>
            </div>
        </section>
    </main>
