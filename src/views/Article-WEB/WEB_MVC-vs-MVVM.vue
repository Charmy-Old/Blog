...
window.onload = C.handleOnload;
                ...
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>當user操作頁面時，view層接收事件給viewModel處理，viewModel呼叫model處理資料</li>
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        ...
                        <ul>
                            ...
                            <li><i class="fa-regular fa-note-sticky"></i>用binding方式連結view，使viewModel可以不用知道是哪個view，而view自行去更新</li>
                    ...
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <h4>結論</h4>
                        <p>MVVM的主要優點是它使View和Model之間實現了完全的分離，同時也減少了Controller的覆雜性。ViewModel的引入使得界面邏輯可以獨立於View進行測試和維護，同時也提高了程式碼的重用性。</p>
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>MVC是較早的模式，用於分離數據、界面和控制邏輯。多注重在於"全端"商業邏輯與資料庫的分離上。而View發展越來複雜之後，為了更方便的管理"前端資料"與UI互動，以及複用component，才出現MVVM。</li>
                            <li><i class="fa-regular fa-note-sticky"></i>MVVM是一種演化自MVC的模式，引入了ViewModel的概念，實現了更好的分離和可維護性。它在現代前端開發中得到廣泛應用。</li>
                        </ul>
                    </div>
                </div>
            </section>
