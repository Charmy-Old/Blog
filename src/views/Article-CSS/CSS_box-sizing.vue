            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>content-box(默認值)：這是標準的盒模型行為，指定的寬度和高度不包括外邊距、內邊距和邊框。換句話說，元素的總寬度和高度是通過將指定的寬度和高度值與外邊距、內邊距和邊框值相加而計算的。</li>
                            <li><i class="fa-regular fa-note-sticky"></i>border-box：使用這個值時，指定的寬度和高度包括內邊距和邊框，但不包括外邊距。換句話說，元素的總寬度和高度是通過從指定的寬度和高度中減去內邊距和邊框值來計算的。</li>
                        </ul>
                    </div>
                </div>
            </section>
