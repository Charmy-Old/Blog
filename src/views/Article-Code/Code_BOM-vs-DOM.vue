...
&lt;/html&gt;
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>父子關係(Parent and Child)：簡單來說就是上下層節點，上層為 Parent Node，下層為 Child Node </li>
                            <li><i class="fa-regular fa-note-sticky"></i>兄弟關係(Siblings)：簡單來說就是同一層節點，彼此間只有 Previous 以及 Next 兩種</li>
                        </ul>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <h4>DOM 操作</h4>
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>document.getElementById("idName")：找尋 DOM 中符合此 id 名稱的元素，並回傳相對應的 element</li>
                            <li><i class="fa-regular fa-note-sticky"></i>document.getElementsBytagName("tag")：找尋 DOM 中符合此 tag 名稱的所有元素，並回傳相對應的 element 集合，集合為 HTMLCollection</li>
                            <li><i class="fa-regular fa-note-sticky"></i>document.getElementsByClassName("className")：找尋 DOM 中符合此 class 名稱的所有元素，並回傳相對應的 element 集合，集合為 HTMLCollection</li>
                            <li><i class="fa-regular fa-note-sticky"></i>document.querySelector("selector")：利用 selector 來找尋 DOM 中的元素，並回傳相對應的第一個 element</li>
                            <li><i class="fa-regular fa-note-sticky"></i>document.querySelectorAll("selector")：利用 selector 來找尋 DOM 中的所有元素，並回傳相對應的第一個 element ，集合為 NodeList</li>
                        </ul>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>HTMLCollection：集合內元素為 HTML element ，也因此 Node type 只能接受 Element</li>
                            <li><i class="fa-regular fa-note-sticky"></i>NodeList：集合內元素為 Node ，也因此全部的 Node 都可以存放在 NodeLists 內</li>
                        </ul>
                    </div>
                    <div class="article-txt" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
            ...
            <section>
                <div class="article-detail" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150"
                    ...
                    <div class="article-list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="150" data-aos-duration="1000">
                        <ul>
                            <li><i class="fa-regular fa-note-sticky"></i>BOM：JavaScript 和『瀏覽器』溝通的窗口，不涉及網頁內容；DOM：JavaScript 用來控制『網頁』的節點與內容的標準</li>
                            <li><i class="fa-regular fa-note-sticky"></i>『BOM』完全依賴瀏覽器廠商實作本身沒有標準規範，『DOM』有 W3C 所制定的標準來規範。</li>
                            <li><i class="fa-regular fa-note-sticky"></i>DOM 最重要的就是觀念，為了不讓網頁在渲染的過程中過度的 重畫頁面(Repaint) 甚至是重構頁面(Reflow) 而讓網頁效能變差，在 DOM 的操作上可要非常小心，而 DOM 也可以說是網頁的核心。</li>
                        </ul>
                    </div>
                </div>
            </section>
