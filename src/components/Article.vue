    ...
    <section class="all others">
        <a href="GIT_basic-instructions" class="article">
            ...
            <div class="article-text">
                ...
                <div class="article-underline"></div>
                <div class="article-content">
                    <p>Git 是一種分散式版本控制系統，被廣泛用於軟體開發領域。主要目的是幫助開發人員有效地協同工作，追蹤代碼變更，並確保代碼的版本歷史得以妥善管理。相較於傳統的集中式版本控制系統，如 Subversion，Git 具有更大的靈活性和強大的分支管理功能。</p>
                </div>
            </div>
        </a>
    </section>
        ...
        <a href="WEB_MVC-vs-MVVM" class="article">
            ...
            <div class="article-text">
                ...
                <div class="article-content">
                    ...
                    <p>MVC（Model-View-Controller）和MVVM（Model-View-ViewModel）是兩種軟體架構模式，用於設計和組織應用程式的不同部分，使其易於維護和擴展。它們各自有自己的特點和用途。</p>
                </div>
            </div>
        </a>
    </section>
